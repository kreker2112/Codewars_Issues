...
//         const peopleGetOnTheBus = busStops[i][0];
//         const peopleGetOffTheBus = busStops[i][1]
//         const peopleWhoStayedInTheBus = peopleGetOnTheBus - peopleGetOffTheBus;
//        resultArray.push(peopleWhoStayedInTheBus);
//     }
//     const result = resultArray.reduce((acc, num) => acc += num, 0);
//     return result;
//   }
